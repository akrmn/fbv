...
obteniendose lo siguiente los de +@tbl:paginas_idx_q13 .
...
se paso a 2923,460 ms. Esto supone una mejora de un 83,60% con respecto a la consulta
...
El arbol de la +@fig:q13i2 es similar al de la Figura 1 salvo por el hecho de que
